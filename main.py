...
app = webapp2.WSGIApplication([
    ...
    ('/blog/(\d+)/comment', PostHandler.CommentPostPage),
    ('/blog/(\d+)/comment/(\d+)/edit', PostHandler.CommentEditPostPage),
    ('/blog/(\d+)/comment/(\d+)/delete', PostHandler.CommentDeletePostPage),
